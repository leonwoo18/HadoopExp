...
public class SoldMapper extends Mapper<LongWritable, Text, Text, Sold> {
    ...
    protected void map(LongWritable k1, Text v1,
        ...
        //data: 13,987,1998-01-10,3,999,1,1232.16
        String data = v1.toString();
        String[] words = data.split(",");

//取data的子串口: t1=987,1998-01-10,3,999,1,1232.16
        String t1 = StringUtils.substringAfter(data, ",");
//取t1的子串为: t2=1998-01-10,3,999,1,1232.16
        String t2 = StringUtils.substringAfter(t1, ",");

//取time为偏移量，数据: words2[0]=1998，words2[1]=01，words2[2]=10
        String[] words2 = t2.split("-");


        Sold sold = new Sold();
        sold.setTime(words[2]);//年份
        sold.setQuantity_sold(Integer.parseInt(words[5]));//销售笔数
        sold.setAmount_sold(Float.valueOf(words[6]));//销售总额
